...
export default function Contact() {
  ...
  return (
    <>
      <AnimatedBackground />
      <Helmet>
        <title>Contact Rohan Fasate</title>

        <meta
          name="description"
          content="Contact Rohan Fasate for freelance projects, web development opportunities and collaborations."
        />
        ...
        <link
          rel="canonical"
          href="https://rohan.nishantp.me/contact"
        />
      </Helmet>
      <>
        <AnimatedBackground />
        <section className="bg-transparent text-white min-h-screen pt-20 sm:pt-24 pb-20 sm:pb-16">
