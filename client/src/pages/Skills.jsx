...
export default function Skills() {
  ...
  return (
    <>
      <Helmet>
        <title>Skills | Rohan Fasate</title>

        <meta
          name="description"
          content="Technical skills of Rohan Fasate including React.js, Node.js, Express.js, MongoDB and MERN stack development."
        />

        <link
          rel="canonical"
          href="https://rohan.nishantp.me/skills"
        />
      </Helmet>
